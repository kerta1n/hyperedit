...
import DiagnosticNoVideo, { params as diagParams, meta as diagMeta } from './diagnostic-no-video';
...
registerTransition('builtin-diagnostic-no-video', DiagnosticNoVideo, diagParams, diagMeta);
